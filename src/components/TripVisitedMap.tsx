            ...
            <div className="relative h-[20rem] overflow-hidden rounded-xl border border-[#dfe5ee] bg-gradient-to-br from-[#f8fbff] to-[#eef3f8] p-3 shadow-inner sm:h-[24rem] lg:h-[28rem] 2xl:h-[31rem]">
              <div className="absolute left-5 top-5 z-10 grid overflow-hidden rounded-xl border border-[#dfe5ee] bg-white shadow-lg">
                <button
                  ...
                  className="grid h-9 w-9 place-items-center border-b border-[#dfe5ee] text-[#0b1326] transition hover:bg-[#f4f7fb]"
                >
                ...
                <button
                  ...
                  className="grid h-9 w-9 place-items-center text-[#0b1326] transition hover:bg-[#f4f7fb]"
                >
              ...
              <button
                ...
                className="absolute bottom-5 left-5 z-10 inline-flex h-10 items-center gap-2 rounded-xl bg-white px-4 text-sm font-bold text-[#45464d] shadow-lg transition hover:bg-[#f4f7fb]"
              >
                      ...
                      geographies.map((geography) => {
                        ...
                        return (
                          <Geography
                            ...
                            className={`outline-none transition duration-150 focus-visible:stroke-[#0b1326] focus-visible:stroke-[1.6] ${isBusy ? 'opacity-45' : 'cursor-pointer'}`}
